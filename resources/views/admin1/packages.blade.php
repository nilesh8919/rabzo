    ...
    <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="ibox-content">Packages
                   ...
                   class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus" aria-hidden="true"></i>Add New</button>
                    ...
                    <tr>
                        <th> Sr.No</th>
                                  ...
                                  <th>Price</th>
                                  <th>Premo Price</th>
                                  <th>Expiration Time(Day)</th>
                                  <th>Usage</th>
                                  <th>Limit Merchant By Sell</th>
                     ...
                     <tbody>
                            ...
                            @foreach($results as $row)
                                ...
                                <td> {{ $row->unlimited_post}}</td>
                                <td> {{ $row->post_limit}}</td>
                                <td> {{ $row->status}}</td>
                               <td>
							   								<a data-toggle="modal" data-target="#myModal" onclick="get_package({{ $row->id }})" style="text-decoration:none; cursor: pointer; cursor: hand;">
                                <i class="clip-remove"></i>Edit</a>|
							    <a onclick="delete_package({{ $row->id }})" style="text-decoration:none; cursor: pointer; cursor: hand;">
