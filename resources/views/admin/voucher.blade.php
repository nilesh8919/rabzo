...
<body>
    ...
    <a style="" type="button" href="{{ url('add_voucher_master') }}"
                    ...
                    <tr>
                     ...
                     <tbody>
                            ...
                            @foreach($results as $row)
                              ...
                              <td>
							<a href="{{ url('get_voucher_master_data_by_id') }}?id={{$row->id}}"  style="text-decoration:none; cursor: pointer; cursor: hand;">
