...
<body>
 ...
 <button style="" type="button" onclick="cleardata()"
                   class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus" aria-hidden="true"></i>Add Category</button>
                    ...
                    <tr>
                     ...
                     <tbody>
                            ...
                            @foreach($results as $row)
							  ...
							  <a onclick="delete_categories({{ $row->id }})" style="text-decoration:none; cursor: pointer; cursor: hand;">
 ...
 function get_categories($id)
 {
	 //alert('hi')
     $.ajax({
                   url: '{{url("get_category_data_by_id")}}',
                   data:{'id':$id},
                   async:false,
                    type: 'GET',
                    dataType: 'json',
               ...
               if(response.flag== true)
                           {
                             ...
                             window.location ='{{url("store_categories_success?msg=")}}'+response.msg;
                           }else 
                           {
            ...
            success: function(response)
                        {
                           if(response.flag== true)
                           {
                                  window.location ='{{url("delete_categories_success")}}'
                           }else 
                           {
