                                        ...
                                        <div class="col-lg-6 col-md-6" style="">
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-8">
                                                         <input type="text" class="form-control" name="email"  value="{{$results->email}}" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-8">
                                                         <input type="text" class="form-control" name="name"  value="{{$results->name}}" required />
                                                    </div>
                                                </div>
												  	<div class="form-group">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <select class="form-control" name="status" id="status" required="true">
                                                             ...
                                                             <option  <?php if($results->status  == 'Inactive'){ echo "selected=selected"; } ?> value="active">Inactive</option>
