...
<body>
 ...
 <a style="" href="{{url('add_new_delivery_boy')}}" onclick="cleardata()"
                     ...
                     <tbody>
                            ...
                            @foreach($results as $row)
                                 <tr>
                                  <td><?php echo $i; ?></td>
                                  <td> {{ $row->boy_name}}</td>
                                  <td> {{ $row->boy_mobile_number}}</td>
                                  <td> {{ $row->username}}</td>
                                  <td> {{ $row->reply_efrom}}</td>
                                  
                                  <td> {{ $row->date_created}}</td>
                                  <td> {{ $row->status}}</td>
                                  <td>

								  <a href="{{url('get_delivery_boy_by_id')}}?id={{$row->id}}"  style="text-decoration:none; cursor: pointer; cursor: hand;">
							  <i class="clip-remove"></i>Edit</a> |
							  <a onclick="delete_delivery_boy({{ $row->id }})" style="text-decoration:none; cursor: pointer; cursor: hand;">
            ...
            success: function(response)
                        {
                           if(response.flag== true)
                           {
                                  window.location ='{{url("manage_delivery_boy")}}'
                           }else 
                           {
