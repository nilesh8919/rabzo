                            ...
                            <form class="form-horizontal" id="upload_form">
                                <div class="col-lg-8 col-md-8">
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label">SIze Name</label>
                                        <div class="col-lg-8">
                                            <input type="text" name="size_name" placeholder="Size Name" class="form-control" required > 
                                        </div>
                                    </div>
                                    <div class="form-group">
