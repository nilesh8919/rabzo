...
<body>
 ...
 <a href="{{url('add_item')}}" style="" type="button" onclick="cleardata()"
                    ...
                    <tr>
                     ...
                     <tbody>
                            ...
                            @foreach($results as $row)
                              ...
                              <td>
							<a href="{{ url('edit_item')}}?id={{$row->id}}"  style="text-decoration:none; cursor: pointer; cursor: hand;">
							  <i class="clip-remove"></i>Edit</a> |
							  <a href="{{ url('delete_item')}}/{{$row->id}}" onclick="return confirm('Are you sure you want to delete?');" style="text-decoration:none; cursor: pointer; cursor: hand;">
