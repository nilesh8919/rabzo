                            ...
                            <form class="form-horizontal" id="upload_form">
                                <div class="col-lg-8 col-md-8">
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label">Cooking Ref. Name</label>
                                        <div class="col-lg-8">
                                            <input type="text" name="cooking_name" placeholder="Cooking Ref. Name" class="form-control"> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <tr>
                     ...
                     <tbody>
                            ...
                            @foreach($results as $row)
							  ...
							  <a onclick="delete_data({{ $row->cook_id }})" style="text-decoration:none; cursor: pointer; cursor: hand;">
               ...
               if(response.flag== true)
                           {
                             ...
                             window.location ='{{url("cooking_reference")}}' ;
                           }else 
                           {
...
function delete_data($id){
      ...
      $.ajax({
            ...
            url: '{{url("delete_cooking_reference")}}',
            type:'get',
            dataType:'json',
            data:{id:$id},
            success: function(response)
